...
- 🎮 **video_game_sales** – This project takes a flat CSV of video game sales rankings and transforms it into a normalised relational database, then uses that database to answer a single business question:
